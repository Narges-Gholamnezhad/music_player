...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  void _addCredit() {
    _showActionDialog(
        "Add Credit", "This feature (Add Credit) is not yet implemented.");
  }
  ...
  //++++++++++++++ متد build در اینجا شروع می‌شود ++++++++++++++
  @override
  Widget build(BuildContext context) {
    ...
    if (_isScreenSpecificDataLoading || userAuthProvider.isLoading) {
  ...
  //++++++++++++++ متدهای کمکی حالا خارج از build و به عنوان متد کلاس تعریف شده‌اند ++++++++++++++
