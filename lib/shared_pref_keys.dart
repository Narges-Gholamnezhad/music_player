...
class SharedPrefKeys {
  // Favorites
  static const String favoriteSongsDataList =
      'favorite_songs_data_list_v2'; // لیست داده کامل آهنگ‌های محبوب (برای FavoritesScreen)
  static const String favoriteSongIdentifiers =
      'favorite_song_identifiers_v2'; // لیست شناسه‌های آهنگ‌های محبوب (برای بررسی سریع)

  // Lyrics (الگوی کلید - خود کلید بر اساس شناسه آهنگ ساخته می‌شود)
  static String lyricsDataKeyForSong(String songUniqueIdentifier) =>
      'song_lyrics_data_$songUniqueIdentifier';
  ...
  static const String userSubscriptionExpiry =
